		...
		<div id="list-producto" class="content scaffold-list" role="main">
			...
			<thead>
					<tr>
						...
						<g:sortableColumn property="stock" title="${message(code: 'producto.stock.label', default: 'Stock')}" />
					
						<th><g:message code="producto.categorias.label" default="Categorias" /></th>
				...
				<g:each in="${productoInstanceList}" status="i" var="productoInstance">
					<tr class="${(i % 2) == 0 ? 'even' : 'odd'}">
						...
						<td>${fieldValue(bean: productoInstance, field: "categorias")}</td>
